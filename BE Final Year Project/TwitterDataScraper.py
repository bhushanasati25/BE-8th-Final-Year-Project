...
# Bearer Token :- AAAAAAAAAAAAAAAAAAAAALA8nAEAAAAABnQ0fqBA5g%2FSGxFSdMAEx28GKQ0%3DoBlQiBADRgIHLwGR0ByMuBJPMDicrdsMs06qCHkmERSDE78VJ8

def scrapeData():
    consumer_key= 'IZfRoLIFgIEIBi4umBFdZVCBR'
    consumer_secret= 'c6SiaaFUiYzd2Rb3Hprv0rKXlt7cAw8ljiII1TLdTaX1wUEAwQ'
    access_token= '3455290334-5LMt9FbNngvTW8Paibd4Z6Eg8sa64nhqPpnfT1z'
    access_token_secret= 'zLnaZ4qewJ4HAu2Khk1z9oDjoZk09M7m6tTSh9NvlJBsH'
    ...
    tweets = tw.Cursor(api.search_tweets,
                q=search_words,
                lang="en").items(no)
    users_locs = [[tweet.id,tweet.created_at,tweet.text]
            for tweet in tweets]
...
headingLabel = tk.Label(headingFrame1, text=" Welcome to Twitter Data Srcaper", fg='grey19', font=('Courier',12,'bold'))
